...
# def seed_database():
    ...
    customers = [
        {"name": "Collins James", "contact": 724556789, "address":"p.o box 453 nrb"},
        {"name": "Ellias Eli", "contact": 768456123, "address":"p.o box 548 nyk"},
        {"name": "Lyn Ozil", "contact": 795324678, "address":"p.o box 48 ksm"},
        {"name": "Richy Bond", "contact": 724697424, "address":"p.o box 23 tz"},
        {"name": "Dan Kingsley", "contact": 7542457, "address":"p.o box 535 india"}
    ]
    for customer_data in customers:
        customer = Customer(name=customer_data["name"], contact=customer_data["contact"], address=customer_data["address"])
